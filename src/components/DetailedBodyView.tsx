  ...
  const parts: Record<string, any> = {
    head: {
      Front: [
        ...
        { name: "HEAD SIDE", x1: 0.88, y1: 0.24, x2: 0.96, y2: 0.34 }, // Right side hair above ear - tightened and raised
        ...
        { name: "EAR PHYSICAL", x1: 0.92, y1: 0.42, x2: 0.98, y2: 0.52 }, // Right ear - moved right onto ear
        { name: "EAR HEARING", x1: 0.02, y1: 0.42, x2: 0.08, y2: 0.52 }, // Left ear - moved onto ear
