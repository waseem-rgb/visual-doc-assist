  ...
  const parts: Record<string, any> = {
    head: {
      Front: [
        ...
        { name: "HEAD SIDE", x1: 0.64, y1: 0.34, x2: 0.68, y2: 0.40 }, // Right head side (temple) - nudged inward
        ...
        { name: "MOUTH", x1: 0.48, y1: 0.60, x2: 0.52, y2: 0.66 }, // Lips center
         { name: "EAR PHYSICAL", x1: 0.71, y1: 0.47, x2: 0.75, y2: 0.53 }, // Right ear - nudged inward
         { name: "EAR HEARING", x1: 0.27, y1: 0.47, x2: 0.31, y2: 0.53 }, // Left ear - nudged inward
    ...
    chest: {
      ...
      "Back view": [
        { name: "SHOULDER BACK", x1: 0.26, y1: 0.30, x2: 0.46, y2: 0.44 }, // aligned to back of left shoulder
    ...
    arms: {
      ...
      "Back view": [
        ...
        { name: "ELBOW", x1: 0.32, y1: 0.64, x2: 0.52, y2: 0.72 }, // moved further down to actual elbow joint
        { name: "HAND BACK", x1: 0.28, y1: 0.78, x2: 0.48, y2: 0.92 }, // moved closer to hand area
      ]
    },
      legs: {
        Front: [
